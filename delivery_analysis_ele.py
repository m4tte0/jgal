...
def analyze_delivery_performance():
    ...
    output_file = Path("Avanzamento_schede_automated_ele.xlsx")
    ...
    print(f"  - Charts saved: 'delivery_analysis_*_ele.png'")
    print(f"  - Summary saved: 'analysis_summary_ele.txt'")
    print(f"{'='*80}")
...
def create_visualizations(deltas, prevista_dates, effettiva_dates, articolo_names,
    ...
    plt.tight_layout()
    plt.savefig('delivery_analysis_overview_ele.png', dpi=300, bbox_inches='tight')
    print("\n[+] Saved: delivery_analysis_overview_ele.png")
...
def create_detailed_charts(deltas, articolo_names, prevista_dates, effettiva_dates):
    ...
    plt.tight_layout()
    plt.savefig('delivery_analysis_top_performers_ele.png', dpi=300, bbox_inches='tight')
    print("[+] Saved: delivery_analysis_top_performers_ele.png")
...
def generate_text_summary(deltas, articolo_names, monthly_deltas,
    ...
    with open('analysis_summary_ele.txt', 'w', encoding='utf-8') as f:
        f.write("="*80 + "\n")
        f.write("DELIVERY PERFORMANCE ANALYSIS - COMPREHENSIVE INSIGHTS\n")
        f.write("="*80 + "\n")
        f.write(f"Generated: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n")
        f.write("Data Source: Avanzamento_schede_automated_ele.xlsx\n")
        ...
        f.write("="*80 + "\n\n")
        f.write("1. delivery_analysis_overview_ele.png - Comprehensive dashboard\n")
        f.write("2. delivery_analysis_top_performers_ele.png - Best/worst comparison\n\n")

        f.write("="*80 + "\n")
        f.write("END OF ANALYSIS\n")
        f.write("="*80 + "\n")

    print("[+] Saved: analysis_summary_ele.txt")
