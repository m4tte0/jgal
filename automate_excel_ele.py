...
def extract_date_from_jgal_csv(csv_file):
    """
    Extract the date from a jgal CSV file where Sequenza = 110.
...
def main():
    ...
    output_file = "Avanzamento_schede_automated_ele.xlsx"
    ...
    for idx, (date, planning_file) in enumerate(planning_dates):
        ...
        # Column 2 = Matricola, Column 4 = Articolo, Column 33 = Rilascio DiBa/Disegni (Ele.)
        matricola_to_date = {}
        articolo_to_date = {}
        ...
        for row_idx in range(planning_data_start_row, planning_ws.max_row + 1):
            ...
            date_cell = planning_ws.cell(row_idx, 33)      # Column 33 = Rilascio DiBa/Disegni (Ele.)
    ...
    for row_idx in range(2, new_ws.max_row + 1):
        ...
        try:
            ...
            # Extract date from CSV file (Sequenza=110)
