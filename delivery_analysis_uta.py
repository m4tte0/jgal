...
def analyze_delivery_performance():
    ...
    output_file = Path("Avanzamento_schede_automated_uta.xlsx")
    ...
    print(f"  - Charts saved: 'delivery_analysis_*_uta.png'")
    print(f"  - Summary saved: 'analysis_summary_uta.txt'")
    print(f"{'='*80}")
...
def create_visualizations(deltas, prevista_dates, effettiva_dates, articolo_names,
    ...
    plt.tight_layout()
    plt.savefig('delivery_analysis_overview_uta.png', dpi=300, bbox_inches='tight')
    print("\n[+] Saved: delivery_analysis_overview_uta.png")
...
def create_detailed_charts(deltas, articolo_names, prevista_dates, effettiva_dates):
    ...
    plt.tight_layout()
    plt.savefig('delivery_analysis_top_performers_uta.png', dpi=300, bbox_inches='tight')
    print("[+] Saved: delivery_analysis_top_performers_uta.png")
...
def generate_text_summary(deltas, articolo_names, monthly_deltas,
    ...
    with open('analysis_summary_uta.txt', 'w', encoding='utf-8') as f:
        f.write("="*80 + "\n")
        f.write("DELIVERY PERFORMANCE ANALYSIS - COMPREHENSIVE INSIGHTS\n")
        f.write("="*80 + "\n")
        f.write(f"Generated: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n")
        f.write("Data Source: Avanzamento_schede_automated_uta.xlsx\n")
        ...
        f.write("="*80 + "\n\n")
        f.write("1. delivery_analysis_overview_uta.png - Comprehensive dashboard\n")
        f.write("2. delivery_analysis_top_performers_uta.png - Best/worst comparison\n\n")

        f.write("="*80 + "\n")
        f.write("END OF ANALYSIS\n")
        f.write("="*80 + "\n")

    print("[+] Saved: analysis_summary_uta.txt")
