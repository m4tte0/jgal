...
def main():
    ...
    output_file = "Avanzamento_schede_automated_uta.xlsx"
    ...
    for idx, (date, planning_file) in enumerate(planning_dates):
        ...
        # Column 2 = Matricola, Column 4 = Articolo, Column 50 = Precollaudo (Inizio)
        matricola_to_date = {}
        articolo_to_date = {}
        ...
        for row_idx in range(planning_data_start_row, planning_ws.max_row + 1):
            ...
            date_cell = planning_ws.cell(row_idx, 50)      # Column 50 = Precollaudo (Inizio)
